  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-display">Groupes & Répétitions</h1>
      ...
      {loading ? (
        ...
        <div className="grid gap-3">
          {groups.map(group => {
            ...
            return (
              <div key={group.id} className="flex items-center justify-between p-4 rounded-xl border border-border-subtle bg-surface/50 hover:bg-surface-overlay transition-all cursor-pointer">
